...
```{r cleanbox, echo=FALSE, fig.cap="The CX2", fig.align='center'}
knitr::include_graphics("CX2.png")
```
...
The following rules apply to the lab, _both physically and virtually_. 
